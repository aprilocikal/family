...
const QUESTION_BANK = [
  ...
  },
  {
    ...
    options: ['Sharing secret jokes and laughing endlessly 🤭', 'Walking side by side, hand in hand 🤝', 'Just sitting in cozy, warm silence together 🛋️', 'Looking into your beautiful eyes and smiling 👀'],
    correct: 1,
  },
  {
  ...
  },
  {
    ...
    options: ['Spring, because you bring new beginnings and life 🌸', 'Summer, because you are warm and full of energy ☀️', 'Autumn, because you are cozy and beautiful 🍁', 'Winter, because you make me want to cuddle ❄️'],
    correct: 0,
  },
  {
...
function getResultMessage(score) {
  if (score === 5) return { emoji: '💕', text: 'You know me perfectly! 💕 We are truly meant to be' };
  if (score >= 3) return { emoji: '🌸', text: 'So close! Keep loving me and you will know everything 🌸' };
  return { emoji: '💗', text: 'Hmm, spend more time with me! 💗' };
}
  ...
  if (finished) {
    ...
    return (
      <div className="love-quiz">
        ...
        <h3 className="love-quiz-title">Love Quiz 💕</h3>
